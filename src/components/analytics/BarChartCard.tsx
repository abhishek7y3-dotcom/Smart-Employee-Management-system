        ...
        {tasks.length > 0 ? (
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={chartData} margin={{ left: -20, right: 10, top: 10, bottom: 5 }}>
              ...
              <Legend verticalAlign="bottom" height={36} iconType="circle" iconSize={8} formatter={(value) => <span className="text-xs font-semibold text-zinc-600 dark:text-zinc-400">{value === 'todo' ? 'To Do' : value === 'inProgress' ? 'In Progress' : 'Completed'}</span>} />
