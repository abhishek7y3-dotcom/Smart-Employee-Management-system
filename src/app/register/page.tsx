    ...
    <div className="min-h-screen flex items-center justify-center bg-zinc-50 px-4 py-12 transition-colors duration-300 dark:bg-zinc-950 relative overflow-hidden">
      ...
      <div className="w-full max-w-md rounded-2xl border border-zinc-200 bg-white p-8 shadow-2xl transition-colors duration-300 dark:border-zinc-800/80 dark:bg-zinc-900/40 dark:backdrop-blur-xl relative overflow-hidden">
        ...
        <div className="text-center relative z-10">
          ...
          <p className="mt-2 text-sm text-zinc-500 dark:text-zinc-400">Join the Employee Task Manager workspace</p>
        </div>
            ...
            {otpSuccess ? (
              ...
              <form onSubmit={handleOtpSubmit} className="space-y-6 text-left">
                <div className="text-center space-y-2">
                  <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-blue-50 dark:bg-blue-950/30 text-blue-600 dark:text-blue-400 border border-blue-100 dark:border-blue-900/50">
                  ...
                  <p className="text-xs text-zinc-500 dark:text-zinc-400">
                    We sent a 6-digit verification code to <span className="font-semibold text-zinc-705 dark:text-zinc-300">{email}</span>.
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    placeholder="000000"
                    required
                    className="mt-2 w-full rounded-xl border border-zinc-300 bg-white px-4 py-3 text-3xl font-mono tracking-[0.5em] text-center text-zinc-950 outline-none transition duration-205 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/10 dark:border-zinc-700/80 dark:bg-zinc-950 dark:text-zinc-50 dark:focus:border-blue-500"
                  />
                </div>
            ...
            <div>
              ...
              <div className="mt-2 flex items-center gap-4">
                {profilePicture ? (
                  ...
                  <div className="flex h-12 w-12 items-center justify-center rounded-full border border-dashed border-zinc-300 bg-zinc-50 text-zinc-405 dark:border-zinc-700 dark:bg-zinc-900">
                ...
                <input
                  ...
                  className="block w-full text-xs text-zinc-500 file:mr-4 file:py-2 file:px-4 file:rounded-xl file:border-0 file:text-xs file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 dark:file:bg-blue-950/40 dark:file:text-blue-400 file:cursor-pointer"
                />
              </div>
            </div>
